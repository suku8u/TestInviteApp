        	...
        	<div class="landing-row">
                <div id="invitation-container" class="mobile-hide">
                	<div id="invitation" class="editable">
                        ...
                        <h1 class="alt" style="margin-top:10px; margin-bottom:20px;"><a href="#menu3">Directions</a></h1>
                    </div><!-- #invitation -->
                ...
                <div class="row">
                    <div class="fivecol">
                        ...
                        <p>Our American wedding celebration will be held on <br/> 
							...
							<br/>
							Please plan to <h4>arrive</h4> between <h4>3:00 PM</h4> and <h4>3:30 PM</h4> to ride the gondola up to the wedding platform.</br>
